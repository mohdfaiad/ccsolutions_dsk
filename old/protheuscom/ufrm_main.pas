...
uses
  ...
  cxContainer, cxEdit, dxSkinscxPCPainter, dxSkinsdxBarPainter, cxLocalization,
  ...
  dxRibbon, Vcl.ExtCtrls, dxGDIPlusClasses;
...
uses ufrm_contract, ufrm_contract_user, ufrm_login, ufrm_client,
  ufrm_enterprise, ufrm_supplier, ufrm_report, ufrm_phonebook;
