inherited frm_print_astpp: Tfrm_print_astpp
  ...
  inherited popup_1: TdxRibbonPopupMenu [12]
    PixelsPerInch = 96
  end
  inherited ActionList_1: TActionList [13]
  ...
  inherited dxBarManager_1: TdxBarManager [14]
    PixelsPerInch = 96
  end
  inherited cxImageList_1: TcxImageList [15]
    FormatVersion = 1
    ImageInfo = <
      item
        Image.Data = {
  ...
  inherited ds: TDataSource [16]
  end
  object memClient: TFDMemTable [17]
    Active = True
    FieldDefs = <
      item
        Name = 'cli_cod'
  ...
  inherited QExport4Dialog_1: TQExport4Dialog [18]
  ...
  object dsClient: TDataSource [19]
    DataSet = memClient
    Left = 960
    Top = 56
  end
  object frxReport_astpp: TfrxReport [20]
    Version = '6.1.9'
    ...
    ReportOptions.CreateDate = 43347.903410810200000000
    ReportOptions.LastChange = 43352.971449606480000000
    ...
    object Ligacoes: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object ClientesNome: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Clientes."Nome"] / [Clientes."Nome Fantasia"]')
          ParentFont = False
        end
        ...
        object ClientesNomeFantasia: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 75.590600000000000000
          Top = 98.267780000000000000
          ...
          Memo.UTF8W = (
              ...
              '[Clientes."Com. - Rua"] - [Clientes."Com. - N'#250'm."], [Clientes."C' +
              'om. - Bairro"]')
          ParentFont = False
          Formats = <
            item
        ...
        object EmpresasRazoSocial: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[Empresas."Raz'#227'o Social"] - [Empresas."Nome Fantasia"]')
        end
        ...
        object ClientesCPFCNPJ: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 75.590600000000000000
          Top = 113.385900000000000000
        ...
        object ClientesCPFCNPJ1: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 115.275665000000000000
          Top = 18.897650000000000000
        ...
        object ClientesEmail: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 115.275665000000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'Ligacoes'
        RowCount = 0
        object LigacoesOrigem: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Width = 75.590600000000000000
          Height = 15.118120000000000000
        ...
        object LigacoesDestino: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 75.590600000000000000
        ...
        object LigacoesData: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object LigacoesTipo: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object LigacoesDurao: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        Width = 718.110700000000000000
        object LigacoesValorTotal: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Top = 26.456710000000000000
          Width = 718.110700000000000000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'Total Consumido: R$ [SUM(<Ligacoes."Valor Total">)]')
          ParentFont = False
        end
        object Memo17: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'Minutos Consumidos: [SUM(<Ligacoes."Dura'#231#227'o">)]')
          ParentFont = False
        end
      end
    end
    object Graficos: TfrxReportPage
      ...
      object Chart1: TfrxChartView
        ...
        Chart = {
          ...
          67656E642E56697369626C65080C50696550656E2E5374796C65070670734461
          73680C50696550656E2E57696474680203000000}
        ChartElevation = 315
        SeriesData = <
          item
            ...
            TopN = 0
            XType = xtText
            Source1 = 'Ligacoes."Origem"'
            Source2 = 'Ligacoes."Valor Total"'
            XSource = 'Ligacoes."Origem"'
            YSource = 'Ligacoes."Valor Total"'
          end>
      end
    end
  end
  inherited qry: TFDQuery [21]
  end
  object dbdsCall: TfrxDBDataset [22]
    UserName = 'Ligacoes'
    CloseDataSource = False
    FieldAliases.Strings = (
      'cli_account_code_astpp=Conta ASTPP'
      'imp_from=Origem'
      'imp_to=Destino'
  ...
  object dbdsClient: TfrxDBDataset [23]
    UserName = 'Clientes'
    CloseDataSource = False
    FieldAliases.Strings = (
      'cli_cod=C'#243'd.'
      ...
      'cli_type=Tipo'
      'cli_first_name=Nome'
      'cli_last_name=Nome Fantasia'
      'cli_email=E-mail'
      'cli_cpfcnpj=CPF/CNPJ'
      'cli_rgie=RG/IE'
      'cli_im=IM'
      'cli_suframa=Suframa'
      'cli_add_bus_zipcode=Com. - CEP'
      'cli_add_bus_address=Com. - Rua'
      'cli_add_bus_number=Com. - N'#250'm.'
      'cli_add_bus_street=Com. - Bairro'
      'cli_add_bus_complement=Com. - Compl.'
      'cli_add_bus_city=Com. - Cidade'
      'cli_add_bus_state=Com. - UF'
      'cli_add_bus_country=Com. - Pa'#237's'
      'cli_add_bil_zipcode=Fin. - CEP'
      'cli_add_bil_address=Fin. - Rua'
      'cli_add_bil_number=Fin. - N'#250'm.'
      'cli_add_bil_street=Fin. - Bairro'
      'cli_add_bil_complement=Fin. - Compl.'
      'cli_add_bil_city=Fin. - Cidade'
      'cli_add_bil_state=Fin. - UF'
      'cli_add_bil_country=Fin. - Bairro'
      'cli_add_del_zipcode=Ent. - CEP'
      'cli_add_del_address=Ent. - Rua'
      'cli_add_del_number=Ent. - N'#250'm.'
      'cli_add_del_street=Ent. - Bairro'
      'cli_add_del_complement=Ent. - Compl.'
      'cli_add_del_city=Ent. - Cidade'
      'cli_add_del_state=Ent. - UF'
      'cli_add_del_country=Ent. - Pa'#237's'
      'cli_phone1=Tel. 1'
      'cli_phone2=Tel. 2'
      'cli_phone3=Tel. 3'
      'cli_phone4=Fax'
      ...
      'cli_dt_birthopen=Dt. Nasc./Abert.'
      'cli_weight=cli_weight'
      'cli_height=cli_height'
      'cli_blood_type=cli_blood_type'
      'cli_rh_factor=cli_rh_factor'
      'cli_du_factor=cli_du_factor'
      'cli_cns=cli_cns'
      'cli_gender=cli_gender'
      'cli_skin_color=cli_skin_color'
      'cli_status=Status'
      'cli_image1=Foto'
      'cli_deleted_at=cli_deleted_at'
  ...
  object memEnterprise: TFDMemTable [24]
    Active = True
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
  ...
  object dsEnterprise: TDataSource [25]
    DataSet = memEnterprise
    Left = 960
    Top = 104
  end
  object dbdsEnterprise: TfrxDBDataset [26]
    UserName = 'Empresas'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ent_cod=C'#243'd.'
      'ent_id=ID'
      'ent_type=Tipo'
      'ent_first_name=Raz'#227'o Social'
      'ent_last_name=Nome Fantasia'
      'ent_nickname=Apelido'
      'ent_email=E-mail'
      'ent_cnpj=CNPJ'
      'ent_ie=IE'
      'ent_im=IM'
      'ent_suframa=Suframa'
      'ent_add_bus_zipcode=CEP'
      'ent_add_bus_address=Rua'
      'ent_add_bus_number=N'#250'm.'
      'ent_add_bus_street=Bairro'
      'ent_add_bus_complement=Compl.'
      'ent_add_bus_city=Cidade'
      'ent_add_bus_state=UF'
      'ent_add_bus_country=Pa'#237's'
      'ent_phone1=Tel. 1'
      'ent_phone2=Tel. 2'
      'ent_phone3=Tel. 3'
      'ent_phone4=Fax'
      'ent_contact=Contato'
      'ent_dt_open=Dt. Abert.'
      'ent_status=Status'
      'ent_image1=Logo'
      'ent_deleted_at=Deletado em'
