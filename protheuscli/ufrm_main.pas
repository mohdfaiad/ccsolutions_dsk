...
<<<<<<< .mine
    Action_AgendaProficional: TAction;
...
<<<<<<< .mine
    procedure Action_AgendaProficionalExecute(Sender: TObject);
||||||| .r289
...
procedure Tfrm_main.Action_AgendaProficionalExecute(Sender: TObject);
begin
  inherited;
