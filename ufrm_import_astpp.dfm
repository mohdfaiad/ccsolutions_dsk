inherited frm_import_astpp: Tfrm_import_astpp
  ...
  inherited dxBarManager_1: TdxBarManager [5]
    ...
    inherited dxBarManager_1Bar3: TdxBar
      DockedLeft = 99
    end
  ...
  inherited qry: TFDQuery
    ...
    SQL.Strings = (
      ...
      'where imp_comp =:comp and contract_ctr_cod =:ctr_cod')
    Left = 504
    Top = 208
    ParamData = <
      item
  ...
  object frxDbLigacoes: TfrxReport
    Version = '6.0.4'
    ...
    ReportOptions.LastChange = 43256.596248784700000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'procedure Button1OnClick(Sender: TfrxComponent);'
      'begin'
      '  data_inicial.Memo.Text:=datetostr(date_inicial.Date);'
      '  data_final.Memo.Text:=dateToStr(date_final.Date);'
      '  data_inicial2.Memo.Text:=datetostr(date_inicial.Date);'
      '  data_final2.Memo.Text:=dateToStr(date_final.Date);'
      ''
      ''
      'end;'
      ''
      ...
      '  qry_cli.First;'
      '  while not qry_cli.Eof do'
      '   begin'
      '    cbCli.Items.Add(<qry_cli."cli_first_name">);'
      '    cbCodCli.Items.Add(<qry_cli."cli_id">);'
      '    qry_Cli.Next;'
      '   end;'
      '   cbCli.ItemIndex:=0;'
      ...
      '  while not qry_enterprise.Eof do'
      '   begin'
      '    cbEmpNome.Items.Add(<qry_enterprise."ent_first_name">);'
      '    cbEmpCod.Items.Add(<qry_enterprise."ent_id">);'
      '    qry_enterprise.Next;'
      '   end;'
      '   cbEmpNome.ItemIndex:=0;'
      ...
      'begin'
      ' cbCli.ItemIndex:=cbCodCli.ItemIndex;'
      'end;'
      ''
    ...
    Datasets = <
      ...
      item
        DataSet = frxDbLigacoes.qry_countLig
      ...
      item
        DataSet = frxDbLigacoes.qry_cli
        DataSetName = 'qry_cli'
      end
      item
        DataSet = frxDbLigacoes.qry_enterprise
    ...
    object Data: TfrxDataPage
      ...
      object qry_import_call_log: TfrxFDQuery
