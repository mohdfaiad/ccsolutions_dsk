...
procedure Tfrm_numero_cliente.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  inherited;
  frm_numero_cliente.Destroy;
  frm_numero_cliente := Nil;
end;
...
procedure Tfrm_numero_cliente.numero_read(AToken: String);
var
  SQL: String;
begin
  SQL := 'call proc_numero_read('+ QuotedStr(AToken) +');';

  sqlnumero.Active    := False;
  sqlnumero.DataBase  := frm_dm.database;
  sqlnumero.SQL.Clear;
  sqlnumero.SQL.Text  := SQL;
  sqlnumero.Active    := True
end;
