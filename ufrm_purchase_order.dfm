inherited frm_purchase_order: Tfrm_purchase_order
  ...
  inherited qry: TFDQuery
    ...
    SQL.Strings = (
        ...
        'and stock_sto_cod in (select sto_cod from stock'#10' where contract_' +
        'ctr_cod =:ctr_cod) and pco_deleted_at is null')
    ParamData = <
      item
        Name = 'CTR_COD'
        DataType = ftBytes
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo7: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'N'#186' do Pedido: [purchase_order."pco_id"]  -  Data: [purchase_orde' +
              'r."pco_dt_registration"]')
          ParentFont = False
          Formats = <
            item
            end
