inherited frm_stock_entry: Tfrm_stock_entry
  ...
  inherited qry: TFDQuery [10]
    ...
    object qryFornecedor: TStringField
      ...
      LookupDataSet = qry_supplier
      LookupKeyFields = 'sup_id'
      LookupResultField = 'sup_first_name'
      KeyFields = 'supplier_sup_id'
      Size = 50
      Lookup = True
    end
    object qryEstoque: TStringField
      FieldKind = fkLookup
      FieldName = 'Estoque'
      LookupDataSet = qry_stock
      LookupKeyFields = 'sto_id'
      LookupResultField = 'sto_name'
      KeyFields = 'stock_sto_id'
      Size = 50
      Lookup = True
    end
  end
  ...
  object qry_product_entry: TFDQuery [12]
    ...
    object qry_product_entryNome_Produto: TStringField
      FieldKind = fkLookup
  ...
  inherited frxReport_1: TfrxReport
    ReportOptions.CreateDate = 43199.551274803200000000
    ReportOptions.LastChange = 43200.399869930600000000
    Left = 223
    Top = 72
    Datasets = <
      item
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Stock_EntradaFornecedor: TfrxMemoView
          IndexTag = 1
          Left = 115.165430000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Stock_Entrada."Fornecedor"]')
        end
        object Stock_EntradaEstoque: TfrxMemoView
          IndexTag = 1
          Left = 115.165430000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Stock_Entrada."Estoque"]')
        end
        object Stock_Entradapde_status: TfrxMemoView
          IndexTag = 1
          Left = 337.645950000000000000
        ...
        object Stock_Entradapurchase_order_pco_id: TfrxMemoView
          IndexTag = 1
          Left = 115.165430000000000000
          Top = 34.456710000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Stock_Entrada."purchase_order_pco_id"]')
        end
      ...
      object DetailData1: TfrxDetailData
        ...
        DataSetName = 'Stock_Entrada_Itens'
        RowCount = 0
        object Stock_Entrada_Itensproduct_pro_id: TfrxMemoView
          IndexTag = 1
          Left = 5.559060000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Stock_Entrada_Itens."product_pro_id"]')
        end
        ...
        object Stock_Entrada_ItensNome_Produto: TfrxMemoView
          IndexTag = 1
          Left = 114.385900000000000000
          Top = 3.779530000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Stock_Entrada_Itens."Nome_Produto"]')
        end
      end
