inherited frm_telephony_report: Tfrm_telephony_report
  ...
  object frxReportConta: TfrxReport
    ...
    ReportOptions.LastChange = 43258.726882534700000000
    ...
    Datasets = <
      ...
      item
        DataSet = frxReportConta.qry_cli
        DataSetName = 'qry_cli'
      end
      item
        DataSet = frxReportConta.qry_countLig
        DataSetName = 'qry_countLig'
      end
      item
        DataSet = frxReportConta.qry_enterprise
        DataSetName = 'qry_enterprise'
      end
      item
        DataSet = frxReportConta.qry_grafico
        DataSetName = 'qry_grafico'
      end
      item
        DataSet = frxReportConta.qry_grafico_total
        DataSetName = 'qry_grafico_total'
      end
      item
        DataSet = frxReportConta.qry_grafico2
    ...
    object Data: TfrxDataPage
      ...
      object qry_countLig: TfrxFDQuery
        UserName = 'qry_countLig'
        ...
        Params = <
          item
            Name = 'dt_ini'
            DataType = ftDateTime
            Expression = 'date_inicial.Date'
          end
          item
            Name = 'dt_fin'
            DataType = ftDateTime
            Expression = 'date_final.Date'
          end>
        SQL.Strings = (
          'select count(imp_id) from import_call_log'
          
            'where imp_date between :dt_ini and :dt_fin                      ' +
            '                                                                ' +
            '       '
          '  ')
        Database = frxReportConta.connect
        pLeft = 181
        pTop = 62
        Parameters = <
          item
      ...
      object qry_grafico: TfrxFDQuery
        ...
        Params = <
          item
            Name = 'dt_ini'
            DataType = ftDateTime
            Expression = 'dateToStr(date_inicial.Date) + '#39' 0:00:00'#39
          end
          item
            Name = 'dt_fin'
            DataType = ftDateTime
            Expression = 'dateToStr(date_final.Date) + '#39' 23:59:59'#39
          end
          item
            Name = 'dt_ini'
            DataType = ftDateTime
      ...
      object qry_grafico_total: TfrxFDQuery
      ...
      object qry_grafico2: TfrxFDQuery
      ...
      object qry_enterprise: TfrxFDQuery
        ...
        Params = <
          item
            Name = 'dt_ini'
            DataType = ftDateTime
            Expression = 'datetostr(date_inicial.Date) + '#39' 00:00:00'#39
          end
          item
            Name = 'dt_fin'
            DataType = ftDateTime
    ...
    object pag_rep_call_log: TfrxReportPage
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo19: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[qry_countLig."count(imp_id)"]')
          ParentFont = False
        end
        object Memo20: TfrxMemoView
          Left = 391.055350000000000000
          Top = 3.000000000000000000
    ...
    object diag_filtro: TfrxDialogPage
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'Tahoma'
      ...
      ClientHeight = 238.000000000000000000
      Left = 508.000000000000000000
      Top = 109.000000000000000000
      Width = 336.000000000000000000
      Scaled = True
      ClientWidth = 320.000000000000000000
      OnShow = 'diag_filtroOnShow'
      ...
      object date_final: TfrxDateEditControl
        ...
        ShowHint = True
        Color = clWindow
        Date = 43190.344160972200000000
        Time = 43190.344160972200000000
        WeekNumbers = False
        OnChange = 'date_inicialOnChange'
      end
      ...
      object date_inicial: TfrxDateEditControl
        Left = 30.000000000000000000
        Top = 49.000000000000000000
        Width = 125.000000000000000000
        Height = 21.000000000000000000
        ShowHint = True
        Color = clWindow
        Date = 43160.344160972200000000
        Time = 43160.344160972200000000
        WeekNumbers = False
        OnChange = 'date_inicialOnChange'
      end
      object Label3: TfrxLabelControl
        ...
        Height = 13.000000000000000000
        ShowHint = True
        Caption = 'Cod. Cliente Sippulse'
        Color = clWhite
      end
      object cbCli: TfrxComboBoxControl
        ...
        ItemIndex = -1
        OnChange = 'cbCliOnChange'
        OnClick = 'cbCliOnClick'
      end
      object cbCodCli: TfrxComboBoxControl
        Left = 30.000000000000000000
        Top = 156.000000000000000000
      ...
      object cbEmpNome: TfrxComboBoxControl
        ...
        Style = csOwnerDrawFixed
        ItemIndex = -1
        OnChange = 'cbEmpNomeOnChange'
        OnClick = 'cbCliOnClick'
      end
      object cbEmpCod: TfrxComboBoxControl
        Left = 30.000000000000000000
        Top = 103.000000000000000000
        Width = 37.000000000000000000
        Height = 21.000000000000000000
